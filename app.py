...
# -------------------------
RAZORPAY_KEY_ID = os.environ.get("RAZORPAY_KEY_ID") or "rzp_live_4YPuylZ30SovI7"
RAZORPAY_KEY_SECRET = os.environ.get("RAZORPAY_KEY_SECRET") or "fD8evCLKX6Pb5GvCcoF8WBnt"
